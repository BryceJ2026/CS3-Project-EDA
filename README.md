...
2. Pie chart for if all weapons have multi target dps
3. Circular bar plot for Class(x axis) and dps(y axis)
4. ANOTHER BAR GRAPH for length of the names(string) and the dps
